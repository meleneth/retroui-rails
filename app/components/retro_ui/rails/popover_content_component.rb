...
module RetroUI
  module Rails
    class PopoverContentComponent < ViewComponent::Base
      ...
      BASE_CLASSES = "absolute left-0 z-40 mt-2 w-72 rounded border-2 border-black bg-card p-4 text-sm text-card-foreground shadow-md"
      ...
      def component_options
        ...
        data[:retro_ui__popover_target] = class_names(data[:retro_ui__popover_target], "content")
